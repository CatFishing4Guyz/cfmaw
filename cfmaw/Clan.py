...
class ClanS1:
    def __init__(self, tag):
        self.tag = tag.strip('#')
        self.url = f"https://api.clashofmagic.cc/magic-s1/clans/{self.tag}"
...
class ClanS2:
    def __init__(self, tag):
        self.tag = tag.strip('#')
        self.url = f"https://api.clashofmagic.cc/magic-s2/clans/{self.tag}"
...
class WarS1:
    def __init__(self, tag):
        self.tag = tag.strip('#')
        self.url = f"https://api.clashofmagic.cc/magic-s1/clans/{self.tag}/currentwar"
