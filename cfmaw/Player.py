...
class PlayerS1:
    def __init__(self, tag):
        self.tag = tag.strip('#')
        self.url = f"https://api.clashofmagic.cc/magic-s1/users/{self.tag}"
...
class PlayerS2:
    def __init__(self, tag):
        self.tag = tag.strip('#')
        self.url = f"https://api.clashofmagic.cc/magic-s2/users/{self.tag}"
...
class TokenS1:
    def __init__(self, tag, token):
        self.tag = tag.strip('#')
        self.token = token
        self.url = f"https://api.clashofmagic.cc/magic-s1/users/{self.tag}/verify"
    ...
    def getResponse(self):
        ...
        self.tokenValidness = json.loads(self.response.content)
        return self.tokenValidness

class TokenS2:
    def __init__(self, tag, token):
        self.tag = tag.strip('#')
        self.token = token
        self.url = f"https://api.clashofmagic.cc/magic-s2/users/{self.tag}/verify"
